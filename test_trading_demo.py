...
# When run in Docker, agent_code is mounted as a module
sys.path.insert(0, "/home/agent")

from agent_code.src.benchmarks.trading_benchmarks.trading_benchmark import TradingBenchmark
from agent_code.src.dsl.interpreter import DslInterpreter
from agent_code.src.dsl.mutator import DslMutator
